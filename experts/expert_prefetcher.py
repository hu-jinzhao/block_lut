...
class ExpertPrefetcher:
    ...
    def set_lut_moe_engine(self, lut_moe_engine):
        self.lut_moe_engine = lut_moe_engine
    ...
    def prefetch_experts_list(
        ...
        for tensor_id in tensor_ids:
            self.lut_moe_engine.enqueue_prefetch(
                tensor_id, 
                0
            )
    def fetch_experts_lock_cache(
        ...
        self.lut_moe_engine.replace_cache_candidates(tensor_ids)
