...
std::unique_ptr<LUT_MoETensorIndex> kTensorIndex(nullptr);



void LUT_MoETensorIndex::Serialize(const char* path) {
...
void LUT_MoETensorIndex::Deserialize(const char* path) {
