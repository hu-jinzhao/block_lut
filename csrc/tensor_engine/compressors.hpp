...
class IdentityCompressor{
    public:
        ...
        IdentityCompressor(const IdentityCompressor&) = delete;
        IdentityCompressor& operator=(const IdentityCompressor&) = delete;
        IdentityCompressor(IdentityCompressor&&) = default;
        IdentityCompressor& operator=(IdentityCompressor&&) = default;
        std::unique_ptr<uint8_t[]> get_compressed_buffer(
            const size_t& input_size,
            size_t& compress_bound
        );
