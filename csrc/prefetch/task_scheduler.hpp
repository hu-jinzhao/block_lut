...
class LUT_MoETaskPool: public base::noncopyable{

public:
    DELETE_COPY_AND_ASSIGN(LUT_MoETaskPool);
    STATIC_GET_INSTANCE(LUT_MoETaskPool);
    LUT_MoETaskPool();
    ~LUT_MoETaskPool(){
        std::cout << "LUT_MoETaskPool destructor" << std::endl;
...
extern std::unique_ptr<LUT_MoETaskPool> kTaskPool;
