...
# 1. Model Selection
print(f"\n\033[1;32mHello, this is LUT_MoE. Please select your model.\033[0m")
...
config = {
    "offload_path": f"/home/hh/LUT-MoE/offload/{target_model_type}_blocklut/",
    "prefetcher_topk": 0,
    "caching_algorithm": "LUT_MoE",
    ...
    "lut_path": f"/home/hh/LUT-MoE/models/{target_model_type}/blocklut_256.npy",
    "nested_shallow_layers": 8,
}
DISPLAY_NAME = {
...
while True:
    try:
        ...
        # 1. Obtain user input
        print(f"\n\033[1;32mHello, this is LUT_MoE inference system, supporting {DISPLAY_NAME[target_model_type]}. Let's begin our conversations!\033[0m")
        ...
        print("\033[1;36mLUT_MoE: \033[0m", end="", flush=True)
