...
sys.stderr.write('Loading BLOCKLUT model...\n')
t0 = time.time()
...
sys.stderr.write(f'Generating...\n')
with torch.no_grad():
    output = model.model.generate(inputs.input_ids, max_new_tokens=32, do_sample=False, pad_token_id=tokenizer.pad_token_id, eos_token_id=tokenizer.eos_token_id)
