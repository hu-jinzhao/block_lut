...
parser = argparse.ArgumentParser("LUT_MoE Benchmark")
parser.add_argument("--system", type=str, default="LUT_MoE")
parser.add_argument(
    "--model_type", 
    type=str, 
    default="deepseek",
...
parser.add_argument("--output_dir", type=str, default="/home/hh/LUT-MoE/evaluation/results/")
parser.add_argument("--dataset_path", type=str, default="/home/hh/LUT-MoE/evaluation/dataset/sharegpt_gpt4.jsonl")
parser.add_argument("--num_test_prompts", type=int, default=96)
parser.add_argument("--test_random_seed", type=int, default=321)
parser.add_argument("--cache_algorithm", type=str, default="LUT_MoE",
                    choices=["LUT_MoE","LFU", "LRU", "Marking","FIFO"])
parser.add_argument("--code_type", type=str, default="LZ4HC",
                    choices=["LZ4HC","LZ4","ZSTD","LUT"])
...
checkpoint = f"/home/hh/LUT-MoE/models/{target_model_type}/"
config = {
    "offload_path": f"/home/hh/LUT-MoE/offload/{target_model_type}/",
    "caching_algorithm": args.cache_algorithm,#"LUT_MoE",
    ...
    "trace_path": f"/home/hh/LUT-MoE/trace/{target_model_type}_trace.pt",
